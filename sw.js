const CACHE='goethia-ia-master-1-1';
const ASSETS=['./','./index.html','./manifest.webmanifest','./data/spirits.json','./data/sources.json','./data/translations.json','./data/settings.json','./assets/hero-goethia.jpg','./assets/spirit-placeholder.jpg'];
